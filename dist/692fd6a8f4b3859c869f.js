import "./styles.css";
import harryPotterImg from "/src/bookImages/harry-potter.png";
import iceAndfireImage from "/src/bookImages/Song_of_Ice_and_Fire.jpg";
import placeHolderImage from "/src/bookImages/book-placeholder.png";
import checkIconImg from "/src/icons/check.png";
import removeIconImg from "/src/icons/delete.png";
...
const myLibrary = [{'BookName': 'Harry Potter', 'author':'j.k Rowling', 'pages':'1,250','read':true, 'img': harryPotterImg},
    {'BookName': 'Song of ice and fire', 'author':'j.r.r Martin', 'pages':'2,550','read':false, 'img':iceAndfireImage}];
...
//-----------------------------------------------------------
  function addBookCard(){
    ...
    removeButton.src = removeIconImg;
  ...
  dialogConfirmBtn.addEventListener('click', (event)=>
{
    ...
    let addnewBook = new AddBookToLibrary(userBookName, userBookAuthor,userBookPages, userBookRead,placeHolderImage);
